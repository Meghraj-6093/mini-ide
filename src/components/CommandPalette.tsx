...
import { Search, Command, Code2 } from 'lucide-react'
...
export const CommandPalette: React.FC = () => {
  ...
  const commands = [
    { id: 'toggleSidebar', label: 'View: Toggle Sidebar', icon: <Code2 className="h-3.5 w-3.5" /> },
    { id: 'toggleTerminal', label: 'View: Toggle Terminal', icon: <Command className="h-3.5 w-3.5" /> },
    ...fileCommands,
  ]
